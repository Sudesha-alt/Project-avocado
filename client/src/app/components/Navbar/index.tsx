        ...
        <div className="flex items-center gap-8">
          {!isSidebarCollapsed ? null : (
            ...
            <div className="relative flex h-min w-[200px]">
                ...
                <input
                className = "w-full rounded border-none p-2 pl-8 placeholder-gray-500 focus:outline-none dark:bg-gray-700 dark:text-white dark:placeholder-white" type="search" placeholder="Search...." />
            </div>
        </div>
